        ...
        flexLines.forEach(function(items){
            ...
            if(flexTotal > 0){
                ...
                if(style.justifyContent === 'space-around'){
                    var step = mainSpace / item.length * mainSpace;
    ...
    flexLines.forEach(function(items){
        ...
        for(var i=0; i<items.length;i++){
            ...
            if(align === 'flex-start'){
                ...
                itemStyle[crossEnd] = itemStyle[crossStart] + crossSign * itemStyle[crossBase];
            }
            ...
            if(align === 'stretch'){
                itemStyle[crossStart] = crossBase;
                itemStyle[crossEnd] = crossBase + crossSign * ((itemStyle[crossSize] !== null && itemStyle[crossSize]!== 0)? itemStyle[crossSize]:lineCrossSize);
